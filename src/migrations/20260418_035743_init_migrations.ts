...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TYPE "public"."enum_items_category" AS ENUM('electronics', 'food', 'office_supplies', 'clothing', 'automotive', 'health', 'toys', 'sports', 'tools', 'books');
  CREATE TYPE "public"."enum_items_unit" AS ENUM('pcs', 'box', 'kg', 'meter');
  ...
  CREATE UNIQUE INDEX "items_code_idx" ON "items" USING btree ("code");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TYPE "public"."enum_items_category";
  DROP TYPE "public"."enum_items_unit";
